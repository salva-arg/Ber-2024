...
// this library is organized into the following sections:
  ...
  Jmol.playAudio = function(applet, params) {
	...
	Jmol._binaryTypes = ["mmtf",".bcif",".gz",".bz2",".jpg",".gif",".png",".zip",".jmol",".bin",".smol",".spartan",".pmb",".mrc",".map",".ccp4",".dn6",".delphi",".omap",".pse",".dcd",".lut",".uk/pdbe/densities/",".uk/pdbe/volume-server/"];
